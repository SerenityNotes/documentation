...
Note: The libsodium documention states that the context is a 8 character string. This is currently not enforced by libsodium.js. See h[https://github.com/jedisct1/libsodium.js/issues/322](https://github.com/jedisct1/libsodium.js/issues/322).
...
- sessionTokenSignature: `login_session_key`
...
## Why is not one chain (basically signed event sourcing) used for a workspace incl. all members, devices, folders, documents?
