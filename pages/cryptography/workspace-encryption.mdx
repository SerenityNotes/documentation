...
- limited to Admins of the workspace only. Any other user should make a request to an admin to rotate the workspace key and admins query for them and add users
- some form of error handling informing the user of a broken state and requesting to invalidate this workspace key?
...
https://github.com/serenity-kit/Serenity/blob/main/apps/app/components/accountMenu/AccountMenu.tsx#L88-L100
https://github.com/serenity-kit/Serenity/blob/main/apps/app/components/accountMenu/AccountMenu.tsx#L195-L209
