...
deviceSigningKeyProof = sign(deviceSigningContent, deviceSigningPrivateKey);
```
...
- deviceSigningKeyProof is valid `signVerify(deviceSigningKeyProof, deviceSigningContent, deviceSigningPublicKey)`
