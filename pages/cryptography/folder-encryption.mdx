...
- The key derivation trace probably should also be included in the AD.
- Should there be a folder chain or a merkel tree to make sure the server either hides all or none subfolders/documents?
- TODO Probably makes sense to includes the document chain hash in the `createDocumentHash`
