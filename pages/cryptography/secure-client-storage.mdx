...
For the mobile devices (ReactNative) currently there is no Sqlite implementation that allows exporting the data nor is there a Sqlite implementation supporting persisting the the database encrypted (e.g. https://github.com/sqlcipher/sqlcipher) and we are looking into forking https://github.com/margelo/react-native-quick-sqlite to support SQLCipher.
...
https://github.com/serenity-kit/Serenity/blob/main/apps/app/utils/authentication/loginHelper.ts#L122-L138

https://github.com/serenity-kit/Serenity/blob/main/apps/app/store/webDeviceStore.ts#L16-L19
