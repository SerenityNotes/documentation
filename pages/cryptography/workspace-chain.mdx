...
An open TODO is to verify if there are checks if the current user's mainDevice is actually part of the chain. If this is not the case the server could provide a workspace the user never agreed to be part of.
