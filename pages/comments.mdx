...
And everytime a new Snapshot is taking we clean out old comment Ids and then they are not accessible anymore to new users or page share links.

Still for every comment we have a trace so admins can still see the history.
